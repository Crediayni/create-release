...
This action has the option of uploading a single asset to the release.  If more than one artifact is needed or if the artifact is not available when the release is created the [Crediayni/upload-release-asset] action can be used.

This action also has the option of deleting the release if it already exists.  If a workflow tries to create a release that already exists it will fail which may happen when a workflow is re-run.  This functionality is also provided in the [Crediayni/delete-release-by-tag] action if a release needs to be deleted before the release is created.
  ...
  create-prebuilt-artifacts-and-release:
    ...
    steps:
      ...
      - name: Create Release
        ...
        uses: Crediayni/create-release@v3.2.0
        with:
...
[Crediayni/delete-release-by-tag]: https://github.com/Crediayni/delete-release-by-tag
[Crediayni/upload-release-asset]: https://github.com/Crediayni/upload-release-asset
